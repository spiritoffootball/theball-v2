		...
		<div class="footer-inner">
			...
			<div class="sof_network network_white clearfix">
				...
				<div class="network_inner clearfix">
					...
					<ul>
						<li class="brazil_icon"><a href="https://spiritoffootball.com.br/" title="<?php esc_attr_e( 'Spirit of Football Brazil', 'the-ball-v2' ); ?>"><?php esc_html_e( 'Spirit of Football Brazil', 'the-ball-v2' ); ?></a></li>
