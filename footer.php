	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="footer-inner">
			...
			<div class="site-info">
				...
				<p><?php printf( esc_html__( 'Website content &copy; %1$sSpirit of Football%2$s %3$s. All rights reserved.', 'theball-v2' ), '<a href="https://spiritoffootball.com">', '</a>', esc_html( gmdate( 'Y' ) ) ); ?></p>
			</div><!-- .site-info -->
